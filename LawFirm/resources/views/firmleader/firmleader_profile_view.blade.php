          ...
          <div class="d-none d-md-block col-md-4 col-xl-4 left-wrapper">
            <div class="card rounded">
              <div class="card-body">
                ...
                <!-- <p>Hi! I'm the firmleader at Pearson Hardman. We hope you enjoy the service and quality of Social.</p> -->
                <div class="mt-3">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin">
                <-- Newly added-- add and ! and >
                <div class="card">
              <div class="card-body">

								<h6 class="card-title">Update Profile</h6>
                            
								<form method= "POST" action= "{{ route('firmleader.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
									@csrf
                                    <div class="mb-3">
